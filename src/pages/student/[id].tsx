    ...
    return (
      <Container>
        ...
        <Main>
          ...
          <Link href="/">
            <a>
              <svg className="m-4 fill-current text-black hover:fill-current hover:text-purple-600 transition duration-300 ease-in-out" width="50" height="50" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
